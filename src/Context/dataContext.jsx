...
export default function DataProvider({ children }) {
  ...
  const fetchData = (e) => {
    ...
    axios
      .get(`${process.env.REACT_APP_BASE_URL}users/finduser`, config)
      .then((result) => {
    ...
    axios
      .get(`${process.env.REACT_APP_BASE_URL}posts`, config)
      .then((result) => {
    ...
    axios
      .get(`${process.env.REACT_APP_BASE_URL}users`, config)
      .then((result) => {
